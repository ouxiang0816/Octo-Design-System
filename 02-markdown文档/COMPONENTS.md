...
| `component.split-tabs` | Split Tabs 分割线页签 | [Split Tabs 分割线页签](#split-tabs) | `SplitTabs` | `#split-tabs` | `synced` |
| `component.selecter-tabs` | Selecter Tabs 选块页签 | [Selecter Tabs 选块页签](#selecter-tabs) | `SelecterTabs` | `#selecter-tabs` | `synced` |
